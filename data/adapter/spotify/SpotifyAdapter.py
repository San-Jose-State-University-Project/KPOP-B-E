...
class SpotifyAdapter:
    ...
    async def get_artist(self, artist_id : str, show_info : bool = False, details : bool = False):
        """아티스트의 정보를 조회할 수 있다."""
    ...
    async def get_track(self, track_id : str, show_info : bool = False, details : bool = False):
        """트랙의 정보를 조회 할 수 있다."""
    ...
    async def get_playlist(self, playlist_id : str, country="KR", show_info : bool = False, details : bool = False):
        """플레이리스트 정보를 조회할 수 있다."""
    ...
    async def search(self, q : SearchQuery, limit=10, offset=0, type : List[str] = "track", country="KR",  details : bool = False):
        """spotify에서 검색할 수 있다.
    ...
    async def artist_top_tracks(self, artist_id : str, show_info : bool = False, details : bool = False):
...
if __name__ == "__main__":
    ...
    playlist_id = "4cRo44TavIHN54w46OqRVc"
    spotify.get_playlist(playlist_id, show_info=True)

    # spotify.get_playlist("37i9dQZF1DX9tPFwDMOaN1", show_info=True)
