...
class GeniusAdapter:
    ...
    async def search_artist(self, artist : str, max_songs : int = 10, sort : str = "popularity", show_info : bool = False):
        """아티스트를 조회할 수 있다."""
    ...
    async def search_song(self, song : str, show_info : bool = False):
        """노래를 조회할 수 있다."""
