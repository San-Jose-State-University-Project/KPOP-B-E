...
class EmotionPipeline:
    ...
    async def classification(self, lyrics: str):
        ...
        for line in lines:
            ...
            translated = await self.translator.translate(line)
            translated_line = translated.text.strip()

            if len(translated_line) > 2000:
                translated_line = translated_line[:2000]

            try:
                emotion = await self.model.analyze(translated_line)
